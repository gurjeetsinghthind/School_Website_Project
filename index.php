                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="ed-com-t1-left">
                            <ul>
                                <li><a href="#">Contact: Lake Road, Suite 180 Farmington Hills, Australia</a>
                                </li>
                                <li><a href="#">Phone: +61 1012311231</a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="carousel-inner">
                <div class="item slider1 active">
                    ...
                    <div class="carousel-caption slider-con">
                        <h2>Welcome to <span>School Management System</span></h2>
                ...
                <div class="item">
                    ...
                    <div class="carousel-caption slider-con">
                        <h2>Fedration <span>University</span></h2>
    ...
    <section class="wed-hom-footer">
        <div class="container">
            ...
            <div class="row wed-foot-link-1">
                <div class="col-md-4 foot-tc-mar-t-o">
                    <h4>Get In Touch</h4>
                    <p>Address: 28800 Orchard Lake Road, Suite 180 Farmington Hills, Australia.</p>
        ...
        <div id="modal1" class="modal fade" role="dialog">
            <div class="log-in-pop">
                ...
                <div class="log-in-pop-right">
                    ...
                    <h4>Login</h4>
                    <p>Don't have an account? Create your account. It's take less then a minutes</p>
                    <form class="s12" method="post" action="Logincheck.php">
                        <div>
                            <div class="input-field s12">
                                <input type="text" data-ng-model="name" name = "user" class="validate">
        ...
        <div id="modal2" class="modal fade" role="dialog">
            <div class="log-in-pop">
                ...
                <div class="log-in-pop-right">
                    ...
                    <p>Don't have an account? Create your account. It's take less then a minutes</p>
                    <form class="s12" method="post" action="register.php">
                        <div>
                            <div class="input-field s12">
                                <input type="text" data-ng-model="name1" name = "user" class="validate">
                                <label>User name</label>
                            </div>
                        </div>
                        <div>
